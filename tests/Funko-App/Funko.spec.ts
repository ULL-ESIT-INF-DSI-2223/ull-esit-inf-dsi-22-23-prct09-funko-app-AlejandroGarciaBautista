...
describe ("Test de la clase Funko", () => {
  ...
  // it ("Prueba de informacion Funko 1", () => {
  //   // Mock logger
  //   let out = "";
  ...
  //   expect(out).to.be.eql(`------- Funko nº: 1 -------
  //   Nombre: Mario
  //   Descripcion: Mario Bros con una estrella
  //   Tipo: Pop!
  //   Genero: Videojuegos
  //   Franquicia: Mario Bros
  //   Número: 12
  //   Exclusivo: false
  //   Caracteristicas especiales: Cabeza XXL
  //   Valor de mercado: Normal
  //   ---------------------------`)
  // });

  // it ("Prueba de informacion Funko 2", () => {
  //   // Mock logger
  //   let out = "";
  //   const defaultLogger = console.log
  //   console.log = (str: string) => out = str
  ...
  // it ("Prueba de informacion Funko3", () => {
  //   // Mock logger
  //   let out = "";
  //   const defaultLogger = console.log
  //   console.log = (str: string) => out = str
  ...
  // it ("Prueba de informacion Funko 4", () => {
  //   // Mock logger
  //   let out = "";
  //   const defaultLogger = console.log
  //   console.log = (str: string) => out = str
